...
#df <- read.csv("./std_pt1_df_2_19_23.csv")
#df <- read.csv("./std_pt1_df_3_1_23.csv")
#df <- read.csv("./std_pt1_df_3_2_23.csv")
#df <- read.csv("./std_pt1_df_7_4_23_partial.csv")
#df <- read.csv("./std_pt1_df_7_4_23.csv")
#df <- read.csv("./std_pt1_df_7_23_23.csv")
#df <- read.csv("./std_pt1_df_11_25_23.csv")
#df <- read.csv("./std_pt1_df_8_3_24.csv")
df <- read.csv("./std_pt1_df_9_23_24.csv")
...
```{r}
# GDP per capita, PPP, year, country - https://data.worldbank.org/indicator/NY.GDP.PCAP.PP.CD
...
# NEW VERSION
#df$country = as.character(df$ethn)
df$country <- "Not included"

df$country[as.character(df$ethn) == "geo: Australian"] = "Australia"

df$country[as.character(df$ethn) == "geo: Brazilian" |
             
           as.character(df$ethn) == "culture: Brazilian"] = "Brazil"

df$country[as.character(df$ethn) == "culture: Chinese Canadian" |
           as.character(df$ethn) == "culture: Hong Kong Chinese Canadian" |
           as.character(df$ethn) == "race/ethn: Canadian" |
           as.character(df$ethn) == "race/ethn: European Canadian"] = "Canada"

df$country[as.character(df$ethn) == "culture: Chinese" |
           as.character(df$ethn) == "geo: Chinese"] = "China"

df$country[as.character(df$ethn) == "geo: Colombian"] = "Colombia"

df$country[as.character(df$ethn) == "culture: French"] = "France"

df$country[as.character(df$ethn) == "culture: German" |
           as.character(df$ethn) == "geo: German"] = "Germany"

df$country[as.character(df$ethn) == "geo: Ghanaian"] = "Ghana"

df$country[as.character(df$ethn) == "culture: Hong Kong Chinese" |
           as.character(df$ethn) == "geo: Hong Kong Chinese"] = "Hong Kong SAR, China"

df$country[as.character(df$ethn) == "geo: Israeli"] = "Israel"

df$country[as.character(df$ethn) == "culture: Japanese" |
           as.character(df$ethn) == "geo: Japanese"] = "Japan"

df$country[as.character(df$ethn) == "culture: Korean" |
           as.character(df$ethn) == "geo: Korean"] = "Korea, Rep."

df$country[as.character(df$ethn) == "culture: Mexican" |
           as.character(df$ethn) == "geo: Mexican"] = "Mexico"

df$country[as.character(df$ethn) == "geo: Polish"] = "Poland"

df$country[as.character(df$ethn) == "geo: Singaporean"] = "Singapore"

df$country[as.character(df$ethn) == "geo: Thai"] = "Thailand"

df$country[as.character(df$ethn) == "geo: Turkish"] = "Turkey"

df$country[as.character(df$ethn) == "culture: British"] = "United Kingdom"

df$country[as.character(df$ethn) == "culture: Asian American" |
           as.character(df$ethn) == "culture: Chinese American" |
           as.character(df$ethn) == "culture: East Asian American" |
           as.character(df$ethn) == "culture: European American" |
           as.character(df$ethn) == "culture: Latino American" |
           as.character(df$ethn) == "geo: US American" |
           as.character(df$ethn) == "race/ethn: African American" |
           as.character(df$ethn) == "race/ethn: Asian American" |
           as.character(df$ethn) == "race/ethn: Chinese American" |
           as.character(df$ethn) == "race/ethn: East Asian American" |
           as.character(df$ethn) == "race/ethn: Ethiopian American" |
           as.character(df$ethn) == "race/ethn: European American" |
           as.character(df$ethn) == "race/ethn: Filipino American" |
           as.character(df$ethn) == "race/ethn: Hispanic American/Latino American" |
           as.character(df$ethn) == "race/ethn: Indian American" |
           as.character(df$ethn) == "race/ethn: Indonesian American" |
           as.character(df$ethn) == "race/ethn: Japanese American" |
           as.character(df$ethn) == "race/ethn: Korean American" |
           as.character(df$ethn) == "race/ethn: Latino American" |
           as.character(df$ethn) == "race/ethn: Mexican American" |
           as.character(df$ethn) == "race/ethn: Middle Eastern American" |
           as.character(df$ethn) == "race/ethn: Native American" |
           as.character(df$ethn) == "race/ethn: Nigerian American" |
           as.character(df$ethn) == "race/ethn: Persian American" |
           as.character(df$ethn) == "race/ethn: Taiwanese American" |
           as.character(df$ethn) == "race/ethn: Vietnamese American" |
             
           as.character(df$ethn) == "culture: European American/Caucasian"
           ] = "United States"
...
```{r}
df$country_surveyed <- df$country

df$country_surveyed[as.character(df$paper_study) == "2009 Scollon study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2012 Chen study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2012 Ruby study1" &
                      as.character(df$ethn) == "race/ethn: Mexican International"] = "Canada"

df$country_surveyed[as.character(df$paper_study) == "2012 Tamir study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2014 Ditzfield Thesis study3"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2014 Ditzfield study1_sample1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2014 Kumar study1" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "2014 Luong study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2015 Chow study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2015 Sims study3" &
                      as.character(df$ethn) == "race/ethn: Asian"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2015 Sims study3" &
                      as.character(df$ethn) == "race/ethn: Black"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2015 Sims study3" &
                      as.character(df$ethn) == "race/ethn: Hispanic"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2015 Sims study3" &
                      as.character(df$ethn) == "race/ethn: Multiracial"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2015 Sims study3" &
                      as.character(df$ethn) == "race/ethn: White"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2016 Thompson study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2016 Tsai study3" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "2017 Chim study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2017 Chim study4a"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2017 Chim study4b"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2017 Floerke study2"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2017 Park study2"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2017 Parker study3"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2017 Sands study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2018 Gentzler study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2018 Lee study2" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "2018 Lin study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2018 Swerdlow study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2018 Swerdlow study2"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2018 Tompson study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2018 Yip study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2019 Kraus study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2019 Li study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2019 Painter study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2019 Palmer study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2020 Koopmann-Holm 1 study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2020 Koopmann-Holm 1 study2"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2020 Koopmann-Holm 1 study3"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2020 Koopmann-Holm 1 study3" &
                      as.character(df$ethn) == "race/ethn: German"] = "Germany"

df$country_surveyed[as.character(df$paper_study) == "2021 Lai study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2021 Millgram study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2021 Song study1" &
                      as.character(df$ethn) == "race/ethn: Black/African American"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2021 Song study1" &
                      as.character(df$ethn) == "race/ethn: Hispanic/Latino"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2021 Song study1" &
                      as.character(df$ethn) == "race/ethn: Native Hawaiian/Pacific Islander"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2021 Song study1" &
                      as.character(df$ethn) == "race/ethn: Other"] = "United States"
df$country_surveyed[as.character(df$paper_study) == "2021 Song study1" &
                      as.character(df$ethn) == "race/ethn: White/Caucasian"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2022 Clobert study12" &
                      as.character(df$ethn) == "geo: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "2022 Senft study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "2022 Yu study1" &
                      as.character(df$ethn) == "geo: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Acevedo study2"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Blevins Dissertation study3" &
                      as.character(df$ethn) == "culture: Chinese International"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Blevins Dissertation study5b" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Cachia Reputation study1" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Cachia Reputation study2" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Cachia Reputation study3" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Cachia Reputation study4" &
                      as.character(df$ethn) == "culture: Taiwanese"] = "Taiwan"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Cheung study1"] = "Canada"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Palmer study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Peruel study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Samanez-Larkin agerl study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Samanez-Larkin finra2 study1"] = "United States"

df$country_surveyed[as.character(df$paper_study) == "Unpublished Yi study1"] = "United States"

table(df$country_surveyed)
...
# Updated w/ 2023 search
# 2021 Millgram study3 (1-10 -> reversed, so 1=10, 10=1)
# Unpublished Blevins Dissertation study3 (1-5, 6 is NA)
# Unpublished Blevins Dissertation study4a (1-5, 6 is NA)
# Unpublished Blevins Dissertation study4b (1-5, 6 is NA)
# Unpublished Blevins Dissertation study5a (1-5, 6 is NA)
# Unpublished Blevins Dissertation study5b (1-5, 6 is NA)
# Unpublished Blevins Dissertation study6 (1-5, 6 is NA)
# Unpublished Blevins Dissertation study7 (1-5, 6 is NA)
# Unpublished Cachia Love study1 (1-5, 6 is NA)
# Unpublished Cachia Love study2 (1-5, 6 is NA)
# Unpublished Cachia Reputation Flipped study1 (1-5, 6 is NA)
# Unpublished Cachia Reputation Graphic study1 (1-5, 6 is NA)
# Unpublished Cachia Reputation study1 (1-5, 6 is NA)
# Unpublished Cachia Reputation study2 (1-5, 6 is NA)
# Unpublished Cachia Reputation study3 (1-5, 6 is NA)
# Unpublished Cachia Reputation study4 (1-5, 6 is NA)
...
# also 2021 Millgram study3 (1-10 -> reversed, so 1=10, 10=1)
df_final$indSES_new <- ifelse(df_final$paper_study == "2021 Millgram study3", 1+4/9*((11-df_final$indSES_new)-1), df_final$indSES_new)
...
# (USD; 1 - < 10k, 2 - 10,001-20k, 3 - 20,001-30k, 4 - 30,001-40k, 5 - 40,001-50k, 6 - 50,001-75k, 7 - 75,001-100k, 8 - >100k) for these studies:
# Unpublished Blevins Dissertation study3
# Unpublished Blevins Dissertation study4a
# Unpublished Blevins Dissertation study4b
# Unpublished Blevins Dissertation study5a
# Unpublished Blevins Dissertation study6
# Unpublished Blevins Dissertation study7
# Unpublished Cachia Reputation Flipped study1
# Unpublished Cachia Reputation Graphic study1
# Unpublished Cachia Reputation study1
# Unpublished Cachia Reputation study2
# Unpublished Cachia Reputation study3
# Unpublished Cachia Reputation study4

# Unpublished Blevins Dissertation study5b has (yuan; 10 - <60k, 13 - 60k-120k, 3 - 120k-180k, 4 - 180k-240k, 5 - 240k-300k, 6 - 300k-450k, 7 - 450k-600k, 12 - >600k), but has values of 9, 10, 13???
...
## Convert all to USD using official exchange rate - ~2015.9 is median, so use 2016
## Data source here: https://data.worldbank.org/indicator/PA.NUS.FCRF
Canada_convert <- 1.3256151637482
China_convert <- 6.644477829
HK_convert <- 7.76225
Japan_convert <- 108.7929
Taiwan_convert <- 30.0 # this is what is used in our lab, since no World Bank data
...
# Unpublished Cachia Reputation study3
# Unpublished Cachia Reputation study4
indincome_2023search_list <- c("Unpublished Blevins Dissertation study3", "Unpublished Blevins Dissertation study4a", "Unpublished Blevins Dissertation study4b", "Unpublished Blevins Dissertation study5a", "Unpublished Blevins Dissertation study6", "Unpublished Blevins Dissertation study7", "Unpublished Cachia Reputation Flipped study1", "Unpublished Cachia Reputation Graphic study1", "Unpublished Cachia Reputation study1", "Unpublished Cachia Reputation study2", "Unpublished Cachia Reputation study3", "Unpublished Cachia Reputation study4")
df_final$indincome_new <- ifelse((df_final$indincome_new == 1 & (df_final$paper_study %in% indincome_2023search_list)), 5000, df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 2 & (df_final$paper_study %in% indincome_2023search_list)), 15000, df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 3 & (df_final$paper_study %in% indincome_2023search_list)), 25000, df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 4 & (df_final$paper_study %in% indincome_2023search_list)), 35000, df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 5 & (df_final$paper_study %in% indincome_2023search_list)), 45000, df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 6 & (df_final$paper_study %in% indincome_2023search_list)), 62500, df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 7 & (df_final$paper_study %in% indincome_2023search_list)), 87500, df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 8 & (df_final$paper_study %in% indincome_2023search_list)), max_mult*100000, df_final$indincome_new)

# Unpublished Blevins Dissertation study5b has for Chinese (yuan; 10 - <60k, 13 - 60k-120k, 3 - 120k-180k, 4 - 180k-240k, 5 - 240k-300k, 6 - 300k-450k, 7 - 450k-600k, 12 - >600k)
df_final$indincome_new <- ifelse((df_final$indincome_new == 10 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 30000*(1/China_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 13 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 90000*(1/China_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 3 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 150000*(1/China_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 4 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 210000*(1/China_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 5 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 270000*(1/China_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 6 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 375000*(1/China_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 7 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 525000*(1/China_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 12 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), max_mult*600000*(1/China_convert), df_final$indincome_new)

# Unpublished Blevins Dissertation study5b has for Taiwanese (NTD; 9 - <300k, 13 - 300k-600k, 15 - 600k-900k, 4 - 900k-1200k, 17 - 1200k-1500k, 6 - 1500k-2250k, 7 - 2250k-3000k, 12 - >3000k)
df_final$indincome_new <- ifelse((df_final$indincome_new == 9 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 150000*(1/Taiwan_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 13 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 450000*(1/Taiwan_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 15 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 750000*(1/Taiwan_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 4 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 1050000*(1/Taiwan_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 17 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 1350000*(1/Taiwan_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 6 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 1875000*(1/Taiwan_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 7 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 2625000*(1/Taiwan_convert), df_final$indincome_new)
df_final$indincome_new <- ifelse((df_final$indincome_new == 12 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), max_mult*3000000*(1/Taiwan_convert), df_final$indincome_new)
```
...
# 2021 Millgram study3 (USD; 1 - <10k, 2 - 10k-25k, 3 - 25k-50k, 4 - 50k-75k, 5 - 75k-100k, 6 - >100k)
...
# Unpublished Blevins Dissertation study6
# Unpublished Blevins Dissertation study7
# Unpublished Cachia Love study2
# Unpublished Cachia Reputation Flipped study1
# Unpublished Cachia Reputation Graphic study1
# Unpublished Cachia Reputation study1
# Unpublished Cachia Reputation study2
...
# Unpublished Blevins Dissertation study5b has (yuan; 10 - <60k, 13 - 60k-120k, 3 - 120k-180k, 4 - 180k-240k, 5 - 240k-300k, 6 - 300k-450k, 7 - 450k-600k, 12 - >600k), but has values of 10, 13, 3, 4, 5, 6, 7, 12, 9, 14, 15
...
# Unpublished Cachia Reputation study3
# Unpublished Cachia Reputation study4
famincome_2023search_list <- c("Unpublished Blevins Dissertation study3", "Unpublished Blevins Dissertation study5a", "Unpublished Blevins Dissertation study6", "Unpublished Blevins Dissertation study7", "Unpublished Cachia Love study2", "Unpublished Cachia Reputation Flipped study1", "Unpublished Cachia Reputation Graphic study1", "Unpublished Cachia Reputation study1", "Unpublished Cachia Reputation study2", "Unpublished Cachia Reputation study3", "Unpublished Cachia Reputation study4")
df_final$famincome_new <- ifelse((df_final$famincome_new == 1 & (df_final$paper_study %in% famincome_2023search_list)), 5000, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 2 & (df_final$paper_study %in% famincome_2023search_list)), 15000, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 3 & (df_final$paper_study %in% famincome_2023search_list)), 25000, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 4 & (df_final$paper_study %in% famincome_2023search_list)), 35000, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 5 & (df_final$paper_study %in% famincome_2023search_list)), 45000, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 6 & (df_final$paper_study %in% famincome_2023search_list)), 62500, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 7 & (df_final$paper_study %in% famincome_2023search_list)), 87500, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 8 & (df_final$paper_study %in% famincome_2023search_list)), max_mult*100000, df_final$famincome_new)

# Unpublished Blevins Dissertation study5b has for Chinese (yuan; 10 - <60k, 13 - 60k-120k, 3 - 120k-180k, 4 - 180k-240k, 5 - 240k-300k, 6 - 300k-450k, 7 - 450k-600k, 12 - >600k)
df_final$famincome_new <- ifelse((df_final$famincome_new == 10 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 30000*(1/China_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 13 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 90000*(1/China_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 3 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 150000*(1/China_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 4 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 210000*(1/China_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 5 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 270000*(1/China_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 6 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 375000*(1/China_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 7 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), 525000*(1/China_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 12 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Chinese"), max_mult*600000*(1/China_convert), df_final$famincome_new)

# Unpublished Blevins Dissertation study5b has for Taiwanese (NTD; 9 - <300k, 13 - 300k-600k, 14 - 600k-900k, 15 - 900k-1200k, 3 - 1200k-1500k, 4 - 1500k-2250k, 5 - 2250k-3000k, 6 - >3000k)
df_final$famincome_new <- ifelse((df_final$famincome_new == 9 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 150000*(1/Taiwan_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 13 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 450000*(1/Taiwan_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 14 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 750000*(1/Taiwan_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 15 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 1050000*(1/Taiwan_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 3 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 1350000*(1/Taiwan_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 4 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 1875000*(1/Taiwan_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 5 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), 2625000*(1/Taiwan_convert), df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 6 & df_final$paper_study == "Unpublished Blevins Dissertation study5b" & df_final$ethn == "culture: Taiwanese"), max_mult*3000000*(1/Taiwan_convert), df_final$famincome_new)


# 2021 Millgram study3 (USD; 1 - <10k, 2 - 10k-25k, 3 - 25k-50k, 4 - 50k-75k, 5 - 75k-100k, 6 - >100k)
df_final$famincome_new <- ifelse((df_final$famincome_new == 1 & df_final$paper_study == "2021 Millgram study3"), 5000, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 2 & df_final$paper_study == "2021 Millgram study3"), 17500, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 3 & df_final$paper_study == "2021 Millgram study3"), 37500, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 4 & df_final$paper_study == "2021 Millgram study3"), 62500, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 5 & df_final$paper_study == "2021 Millgram study3"), 87500, df_final$famincome_new)
df_final$famincome_new <- ifelse((df_final$famincome_new == 6 & df_final$paper_study == "2021 Millgram study3"), max_mult*100000, df_final$famincome_new)
```


```{r}
df_final <- df_final[order(df_final$"Unnamed..0"), ]
#write.csv(df_final, "std_pt2_df_7_23_23.csv", row.names = FALSE, na="")
#write.csv(df_final, "withcountry_std_pt2_df_7_23_23.csv", row.names = FALSE, na="")
#write.csv(df_final, "std_pt2_df_11_25_23.csv", row.names = FALSE, na="")
#write.csv(df_final, "std_pt2_df_8_3_24.csv", row.names = FALSE, na="")
write.csv(df_final, "std_pt2_df_9_23_24.csv", row.names = FALSE, na="")
```